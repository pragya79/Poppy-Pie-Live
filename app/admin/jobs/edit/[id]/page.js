...
export default function EditJob() {
    ...
    useEffect(() => {
        ...
        if (jobId && !loading && isAuthenticated && isAdmin()) {
            fetchJob()
        }
    }, [jobId, loading, isAuthenticated, isAdmin, router])
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Requirements - Same as create page but with existing data */}
                        <Card>
                            <CardHeader>
                    ...
                    {/* Sidebar - Same structure as create page */}
                    <div className="space-y-6">
                        <Card>
                            <CardHeader>
